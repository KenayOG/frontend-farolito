...
} from './inventario/administracion-inventario/administracion-inventario.component';
...
} from './inventario/agregar-lote-componentes/agregar-lote-componentes.component';
...
export const routes: Routes = [
  ...
  {path: 'pagar-carrito', component: ConfirmarCarritoComponent, canActivate: [authGuard]},
  {
    path: 'usuarios',
  ...
  {path: 'editar-empleado', component: EditarEmpleadoComponent, canActivate: [authGuard]},
  {
    path: 'proveedores',
  ...
  {path: 'editar-proveedor', component: EditarProveedorComponent, canActivate: [authGuard]},
  ...
  {path: 'editar-receta', component: EditarRecetasComponent, canActivate: [authGuard]},
  {
    path: 'inventario',
  ...
  {path: 'agregar-lote/:id', component: AgregarLoteComponentesComponent, canActivate: [authGuard]},
  {
    path: 'dashboard',
  ...
  {path: 'detalle-pedido/:id', component: DetallePedidoClienteComponent, canActivate: [authGuard]},
  {
    path: 'merma',
  ...
  {path: 'mi-perfil', component: VerDatosPerfilComponent, canActivate: [authGuard]},
  {
    path: 'finanzas',
  ...
  {path: 'generar-produccion', component: GenerarProduccionComponent, canActivate: [authGuard]},
  {path: 'catalogo-componentes', component: AgregarComponenteComponent, canActivate: [authGuard]},
  {
    path: 'compras',
